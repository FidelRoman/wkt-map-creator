  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-4xl font-extrabold text-slate-900 mb-4">404 - Página no encontrada</h1>
        <p className="text-slate-500 mb-8">Lo sentimos, la página que estás buscando no existe, ha sido movida o está temporalmente indisponible.</p>
        <Link
          href="/"
